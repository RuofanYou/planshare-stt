...
- 举报治理误隐藏防呆补缺口：后台举报队列“隐藏板”新增页面内二次确认；取消不隐藏，确认后才隐藏公开板。
...
✓   1 [chromium] › tests/e2e/ugc-smoke.spec.ts:172:1 › UGC smoke: browse, copy, submit, approve, publish, and creator direct post (16.8s)
✓   2 [chromium] › tests/e2e/ugc-smoke.spec.ts:447:1 › creator application guardrails handle missing fields, invalid usernames, and duplicates (2.0s)
...
✓   5 [chromium] › tests/e2e/ugc-smoke.spec.ts:596:1 › admin can suspend and restore a creator account (7.6s)
...
✓  14 [chromium] › tests/e2e/ugc-smoke.spec.ts:991:1 › admin resource deletion requires confirmation before removing bosses and raids (1.6s)
✓  19 [chromium] › tests/e2e/ugc-smoke.spec.ts:1186:1 › visitor can check submission receipt and open the approved board (980ms)
✓  20 [chromium] › tests/e2e/ugc-smoke.spec.ts:1220:1 › visitor rejected receipt can return to a clean resubmission form (611ms)
✓  21 [chromium] › tests/e2e/ugc-smoke.spec.ts:1249:1 › visitor spam receipt can return to a clean resubmission form (599ms)
✓  22 [chromium] › tests/e2e/ugc-smoke.spec.ts:1272:1 › visitor withdrawn receipt can return to a clean resubmission form (637ms)
✓  23 [chromium] › tests/e2e/ugc-smoke.spec.ts:1298:1 › submission receipt rate limit shows a visible visitor-facing error (591ms)
✓  25 [chromium] › tests/e2e/ugc-smoke.spec.ts:1355:1 › duplicate visitor submission explains that the same content will not enter review twice (1.1s)
✓  27 [chromium] › tests/e2e/ugc-smoke.spec.ts:1416:1 › visitor can report a board and admin can hide it from public pages (10.2s)
✓  29 [chromium] › tests/e2e/ugc-smoke.spec.ts:1536:1 › creator direct publish screens unsafe content in dashboard (782ms)
29 passed (1.3m)
```
...
✓   1 [chromium] › tests/e2e/ugc-smoke.spec.ts:187:1 › UGC smoke: browse, copy, submit, approve, publish, and creator direct post (11.9s)
✓   2 [chromium] › tests/e2e/ugc-smoke.spec.ts:462:1 › creator self-service promotion uses the visible submission flow for all three approvals (6.8s)
✓   6 [chromium] › tests/e2e/ugc-smoke.spec.ts:668:1 › creator active session is cleared on focus after admin password reset (5.7s)
✓   7 [chromium] › tests/e2e/ugc-smoke.spec.ts:699:1 › admin can suspend and restore a creator account (2.5s)
✓  20 [chromium] › tests/e2e/ugc-smoke.spec.ts:1230:1 › submit draft survives reload without saving password or contact (2.3s)
✓  29 [chromium] › tests/e2e/ugc-smoke.spec.ts:1519:1 › visitor can report a board and admin can hide it from public pages (10.1s)
...
✓   1 [chromium] › tests/e2e/ugc-smoke.spec.ts:187:1 › UGC smoke: browse, copy, submit, approve, publish, and creator direct post (12.5s)
✓   6 [chromium] › tests/e2e/ugc-smoke.spec.ts:668:1 › creator active session is cleared on focus after admin password reset (5.5s)
✓   7 [chromium] › tests/e2e/ugc-smoke.spec.ts:699:1 › admin can suspend and restore a creator account (2.7s)
✓   8 [chromium] › tests/e2e/ugc-smoke.spec.ts:749:1 › admin bulk submission actions require confirmation (1.6s)
✓  30 [chromium] › tests/e2e/ugc-smoke.spec.ts:1606:1 › creator dashboard blocks self-restore for boards hidden by admin reports (604ms)
...
✓   1 [chromium] › tests/e2e/ugc-smoke.spec.ts:187:1 › UGC smoke: browse, copy, submit, approve, publish, and creator direct post (12.1s)
✓   7 [chromium] › tests/e2e/ugc-smoke.spec.ts:699:1 › admin can suspend and restore a creator account (2.8s)
✓   8 [chromium] › tests/e2e/ugc-smoke.spec.ts:749:1 › admin bulk submission actions require confirmation (1.7s)
✓  29 [chromium] › tests/e2e/ugc-smoke.spec.ts:1537:1 › visitor can report a board and admin can hide it from public pages (10.4s)
✓  30 [chromium] › tests/e2e/ugc-smoke.spec.ts:1612:1 › creator dashboard blocks self-restore for boards hidden by admin reports (5.7s)
...
✓   2 [chromium] › tests/e2e/ugc-smoke.spec.ts:488:1 › creator self-service promotion uses the visible submission flow for all three approvals (7.6s)
✓  20 [chromium] › tests/e2e/ugc-smoke.spec.ts:1274:1 › submit draft survives reload without saving password or contact (2.4s)
✓  29 [chromium] › tests/e2e/ugc-smoke.spec.ts:1569:1 › visitor can report a board and admin can hide it from public pages (10.6s)
...
✓   2 [chromium] › tests/e2e/ugc-smoke.spec.ts:488:1 › creator self-service promotion uses the visible submission flow for all three approvals (7.5s)
...
✓  21 [chromium] › tests/e2e/ugc-smoke.spec.ts:1307:1 › submit draft survives reload without saving password or contact (2.4s)
...
✓  21 [chromium] › tests/e2e/ugc-smoke.spec.ts:1341:1 › submit draft survives reload without saving password or contact (2.5s)
...
✓   1 [chromium] › tests/e2e/ugc-smoke.spec.ts:187:1 › UGC smoke: browse, copy, submit, approve, publish, and creator direct post (12.7s)
✓   2 [chromium] › tests/e2e/ugc-smoke.spec.ts:488:1 › creator self-service promotion uses the visible submission flow for all three approvals (7.5s)
...
✓  21 [chromium] › tests/e2e/ugc-smoke.spec.ts:1344:1 › submit draft survives reload without saving password or contact (2.8s)
...
## 高风险 diff
- `src/pages/Admin.tsx`：管理员重置创作者密码后新增“隐藏新密码”；需人工确认客服流程里复制后立即隐藏明文符合运营习惯。
...
- `src/pages/Creator.tsx`：创作者“恢复发布”新增页面内二次确认；需人工确认恢复公开前多一步确认符合高频维护体验。
...
- `server/index.mjs`、`src/pages/admin/ReportsSection.tsx`、`src/data/types.ts`：举报新增板内容快照并在后台展示；隐藏板已改为二次确认，需人工确认正文摘录长度、后台可见信息范围和隐藏确认文案符合运营预期。
